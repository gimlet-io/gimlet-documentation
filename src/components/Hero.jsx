          ...
          <div className="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
            <div>
              ...
              <div>
                ...
                <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300 sm:text-center">We got you covered. Gimlet is a gitops based developer platform that gives you the best of open-source out of the box. The platform you would build given enough time, but why would you? We built it already for you.</p>

        ...
        <div className="min-w-0 max-w-2xl flex-auto px-4 py-16 lg:max-w-none lg:pr-0 lg:pl-8 xl:px-16">
          ...
          <>
            ...
            <div className='flex mt-8'>
              ...
              <div className='ml-2'>
                <h2 className="mb-2 font-medium underline"><a href="/blog/announcing-the-gimlet-saas-early-access">The how and why we built our SaaS platform on Kubernetes and Hetzner</a></h2>

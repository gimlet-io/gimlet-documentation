    ...
    links: [
      {
        ...
        href: '/docs/frontend/next-js-deployment-tutorial',
      },
      {
        title: 'React Deployment',
        href: '/docs/frontend/react-deployment-tutorial',
      },
      {
        title: 'Remix Deployment',
        href: '/docs/frontend/remix-deployment-tutorial',
      },
      {
        title: 'Static Site Deployment',
        href: '/docs/frontend/static-site-deployment-tutorial',
      },
      {
        title: 'Vue.js Deployment',
        href: '/docs/frontend/vue-deployment-tutorial',
      },
    ],
  },
  {
    ...
    links: [
      {
        ...
        href: '/docs/backend/laravel-deployment-tutorial',
      },
      {
        title: 'Django Deployment',
        href: '/docs/backend/django-deployment-tutorial',
      },
    ],
  },
  {
    ...
    links: [
      {
        title: 'Flowise Deployment',
        href: '/docs/ai-deployments/flowise-deployment-tutorial',
      },
      {
        title: 'Dockerfile Deployments',
        href: '/docs/ai-deployments/dockerfile-deployment-tutorial',
      },
      {
        title: 'Streamlit Deployment',
        href: '/docs/ai-deployments/streamlit-deployment-tutorial',
      },
      {
        title: 'Jupyter Notebook Deployments',
        href: '/docs/ai-deployments/jupyter-notebook-deployment-tutorial',
      },
      {
        title: 'vLLM Deployment',
        href: '/docs/ai-deployments/vllm-deployment-tutorial',
      },
      {
        title: 'Hugging Face Model Deployments',
        href: '/docs/ai-deployments/hugging-face-model-deployment-tutorial',
      },
    ],
  },
  {
    ...
    links: [
      ...
      { title: 'Rollbacks', href: '/docs/deployments/rollbacks' },
      {
        ...
        href: '/docs/deployments/automated-deployments',
      },
    ],
  },
  {
    ...
    links: [
      {
        title: 'Introduction',
        href: '/docs/deployment-settings/deployment-configuration',
      },
      {
        title: 'Container Build Settings',
        href: '/docs/deployment-settings/image-settings',
      },
      {
        title: 'Container Registries',
        href: '/docs/deployment-settings/registries',
      },
      {
        title: 'Social Authentication',
        href: '/docs/deployment-settings/social-authentication',
      },
      { title: 'DNS', href: '/docs/deployment-settings/dns' },
      {
        title: 'Port Forwarding',
        href: '/docs/deployment-settings/port-forwarding',
      },
      ...
      { title: 'Volumes', href: '/docs/deployment-settings/volumes' },
      {
        ...
        href: '/docs/deployment-settings/resource-usage',
      },
      {
        title: 'Chat Notifications',
        href: '/docs/deployment-settings/chat-notifications',
      },
      {
        title: 'Creating a Custom Template',
        href: '/docs/deployment-settings/custom-template',
      },
    ],
  },
  {
    ...
    links: [
      {
        title: 'Introduction',
        href: '/docs/environment-settings/introduction',
      },
      {
        title: 'Component updates',
        href: '/docs/environment-settings/component-updates',
      },
    ],
  },
  {
    ...
    links: [
      ...
      {
        title: 'Integated Kubernetes Alerts',
        href: '/docs/monitoring/integrated-kubernetes-alerts',
      },
    ],
  },
  {
    ...
    links: [
      {
        ...
        href: '/docs/kubernetes-resources/kubernetes-essentials',
      },
      {
        title: 'Troubleshooting',
        href: '/docs/kubernetes-resources/troubleshooting',
      },
    ],
  },
  {
    ...
    links: [
      {
        ...
        href: '/docs/reference/gimlet-manifest-reference',
      },
      { title: 'CI plugins Reference', href: '/docs/reference/ci-plugins' },
      {
        title: 'Gimlet Configuration Reference',
        href: '/docs/reference/gimlet-configuration-reference',
      },
      {
        title: 'Onechart Reference',
        href: '/docs/reference/onechart-reference',
      },
    ],
  },
  {
    ...
    links: [
      {
        ...
        href: '/docs/learn-more/gimlet-compared-to',
      },
...
export default function App({ Component, pageProps }) {
  ...
  let tableOfContents =
    pageProps.markdoc?.frontmatter.toc !== false && pageProps.markdoc?.content
  ...
  if (isYamlGeneratorPage) {
    ...
    description =
      'Generate Kubernetes YAML files for web application deployments. Uses a generic Helm chart, because no one can remember the Kubernetes yaml syntax.'
  ...
  return (
    <>
      <Head>
        ...
        <meta
          content={`https://api.placid.app/u/ghvjld730lsgd?title[text]=${encodeURI(
            ogTitle
          )}`}
          property="og:image"
        />

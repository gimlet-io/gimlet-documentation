...
- The Service uses a third-party, posthog.com to provide in-product analytics and better understand product usage. Posthog.com is GDPR compliant and the Service has a data processing agreement with it.

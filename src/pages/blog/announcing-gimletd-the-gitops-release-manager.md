...
You can read more about the [concepts of GimletD](/docs/concepts) or follow how to
perform ad-hoc releases and rollbacks in the [GimletD documentation](/docs/deployments/rollbacks).
